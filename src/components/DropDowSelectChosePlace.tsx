...
const DropDowSelectChosePlace = memo(
  ({
    ...
    const { handleClickInside, clickShow, setClickShow, ref } = useClickFocus();
    return (
      <div
        ref={ref}
        className={clsx(
      ...
      >
        ...
        >
          <InputElement
            className="!border-r-transparent rounded-r-none !border-l-transparent"
            value={value ?? ""}
        ...
        {clickShow && (
          <div
            className={
              "w-full border border-border rounded-10 bg-white  h-200 overflow-scroll hidden-scroll shadow-sm z-50"
            }
          >
            {children}
          </div>

  ...
  const formik = useFormik<solutionType>({
    ...
    onSubmit: async (value) => {
      try {
        ...
        toast.success(
          id
            ? t("message.success.updated_content")
            : t("message.success.posted_content")
        );
      } catch (error) {
        toast.error(
          id
            ? t("message.error.updated_content")
            : t("message.error.posted_content")
        );
      }
    },
  });
      ...
      <div className="my-10 flex flex-col gap-4">
        <div className="flex flex-wrap gap-6 items-center mb-6">
          <div>
            ...
            <InputUploadFile onChange={handleChangeFile} />
          </div>
          {preViewImage != "" && (
            <div>
        ...
        {errors.link && touched.link && (
          <TextError text={errors.link} option={{ name: "ảnh" }} />
        )}
        ...
        <div>
          ...
          {errors.idCategory && touched.idCategory && (
            <TextError
              ...
              option={{ name: "danh mục giải pháp", length: 255 }}
            />
          )}
        </div>
        <div>
          ...
          {errors.title && touched.title && (
            <TextError
              text={errors.title ?? ""}
              option={{ name: "tiêu đê", length: 255 }}
            />
          )}
        </div>
        <div>

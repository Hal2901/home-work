...
const EditWarranty = ({type}:Props) => {
  ...
  useEffect(() => {
    switch(type) {
      ...
      case 'edit':
        const id = window.location.pathname.split("/").reverse()[0];
        guaranteeService.getGuaranteeDetail(id)
        .then( (result:WarrantyType) => {
              ...
              <div>
                ...
                {errors.warranty?.code && touched.warranty?.code && (
                  <TextError
                    ...
                    option={{ name: "số chứng nhận bảo hành", length: 255 }}
                  />
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <InputElement
                    ...
                    disabled={type === "view"}
                  />
                  {errors.warranty?.startDate && touched.warranty?.startDate && (
                    <TextError
                      text={errors.warranty?.startDate}
                      option={{ name: "thời gian bắt đầu", length: 255 }}
                    />
                  )}
                </div>
                <div>
                  ...
                  {errors.warranty?.endDate && touched.warranty?.endDate && (
                    <TextError
                      ...
                      option={{ name: "thời gian kết thúc", length: 255 }}
                    />
                  )}
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <InputElement
                  ...
                  // value={values.warranty.projectName}
                  // onChange={(e: any) => handleChangeKeyValue(e, "projectName")}
                  disabled={type === "view"}
                />
              ...
              <div>
                ...
                {errors.warranty?.fullname && touched.warranty?.fullname && (
                  <TextError
                    ...
                    option={{ name: "tên chủ đầu tư", length: 255 }}
                  />
                )}
              </div>
              ...
              <div>
                ...
                <InputElement
                  ...
                  disabled={type === "view"}
                />
                {errors.warranty?.namePackage && touched.warranty?.namePackage && (
                  <TextError
                    text={errors.warranty?.namePackage}
                    option={{ name: "tên gói thầu", length: 255 }}
                  />
                )}
              </div>
            </div>
              ...
              <div>
                ...
                {errors.warranty?.codeLSI && touched.warranty?.codeLSI && (
                  <TextError
                    ...
                    option={{ name: "số chứng nhận LSI", length: 255 }}
                  />
                )}
              </div>
              <div>
                <LabelInput text="installation_company_name" isRequire={false} />
                <InputElement
                  ...
                  disabled={type === "view"}
                />
                {errors.warranty?.nameCompany && touched.warranty?.nameCompany && (
                  <TextError
                    text={errors.warranty?.nameCompany}
                    option={{ name: "tên công ty lắp đặt", length: 255 }}
                  />
                )}
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <InputElement
                  ...
                  onChange={(e: any) => handleChangeKeyValue(e, "nameDistributor")}
                  disabled={type === "view"}
                />
                {errors.warranty?.nameDistributor && touched.warranty?.nameDistributor && (
                  <TextError
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <InputElement
                    ...
                    type="number"
                    onChange={(e: any) => handleChangeKeyValue(e, "numDistributor")}
                    disabled={type === "view"}
                  />
                  {errors.warranty?.numDistributor && touched.warranty?.numDistributor && (
                    <TextError
                      text={errors.warranty?.numDistributor}
                      option={{ name: "đơn đặt hàng số", length: 255 }}
                    />
                  )}
                </div>
                <div>
                  ...
                  <InputElement
                    name="name"
                    type="date"
                    onChange={(e: any) => handleChangeKeyValue(e, "dateDistributor")}
                    disabled={type === "view"}
                  />
                  {errors.warranty?.dateDistributor && touched.warranty?.dateDistributor && (
                    <TextError
                      text={errors.warranty?.dateDistributor}
                      option={{ name: "ngày đặt hàng", length: 255 }}
                    />
                  )}
                </div>
              </div>

...
const RegisterToBecomeAPartner = () => {
  ...
  const formik = useFormik<PartnerType>({
    ...
    onSubmit: async (value: any) => {
      try {
        const requestRegisted = await partnerService.addPartner({
          ...value,
          feedback: null,
        });
        resetFormValue();
  ...
  return (
    <div>
      ...
      <div className="sc1800:px-300 xl:px-[155px] sm:px-100 px-5 lg:py-88 py-10">
          ...
          <div>
            ...
            {errors.person?.phone && touched.person?.phone && (
              <TextError
                ...
                option={{ name: "số điện thoại", length: 10 }}
              />
            )}
          </div>
          <div>
            ...
            {errors.person?.fax && touched.person?.fax && (
              <TextError text={errors.person.fax} option={{ name: "fax" }} />
            )}
          </div>
          <div>
        ...
        <p>
          LS Cable & System., Ltd. thu thập thông tin cá nhân của bạn để đăng ký
          bạn làm đối tác. Để biết thêm thông tin, vui lòng xem [ &nbsp;
